    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 newFor = glm::vec4(forward, 1.0);
            glm::vec4 newForward = glm::rotate(glm::mat4(1), angle, right) * newFor;
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 newForward = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 1);
            glm::vec4 newRight = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 newRight = glm::rotate(glm::mat4(1), angle, forward) * glm::vec4(right, 1);
